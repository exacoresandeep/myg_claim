...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE `myg_08_trip_claim` ADD `ApproverRemarks` VARCHAR(500) AFTER `Status`");
    }
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE `myg_08_trip_claim` DROP COLUMN `ApproverRemarks`");
    }
};
