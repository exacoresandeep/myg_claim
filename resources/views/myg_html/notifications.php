        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr>              
              ...
              <td>01-05-2024</td>
              <td>
                New claim request has been received, claim ID:TID5000
              </td>              
              <td>
                <a href="claim-view.php" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a>               
              </td>
            </tr>            
            <tr>              
              <td>02.</td>
              <td>01-05-2024</td>
              <td>
                15 New claim request has been received
              </td>              
              <td>
                <a href="claim-view.php" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a>            
              </td>
